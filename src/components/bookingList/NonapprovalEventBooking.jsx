...
import {
  nonapprovalList,
  nonapprovedEventBookings,
} from "../../utils/Constants";
import { useSelector } from "react-redux";
import "./BookingList.scss";

const NonapprovedEventBookingList = () => {
  ...
  const getBookingsList = () => {
    axios
      .get(`${nonapprovedEventBookings}${user.id}?page=${page}`, {
        headers: {
    ...
    >
      ...
      <section className="mx-auto w-full max-w-7xl px-4 py-4">
        <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
          <div>
            <h2 className="text-lg font-semibold">NON APPROVAL LIST</h2>
          </div>
          <div></div>
        </div>
...
export default NonapprovedEventBookingList;
